    ...
    render() {
        return (
            <div>
                ...
                <div>
                    We encourage our pup parents to call and check on their baby whenever they want. Our staff is great at sending pictures and updates whenever requested by the owner! 
                </div>
                <div>
                <h1>Boarding</h1>
                ...
                <div>
                    <h6>
                        Daycare is included in our boarding price. This means your pup will be playing with not only the other boarding pups, but the pups who come in for Doggy Daycare.
                    </h6>
                </div>
            </div>
